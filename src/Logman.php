 ...
 * Logman
 *
 * @method static void setup(string $channelName, string $format, boolean $withJson)
...
class Logman
{
     ...
     * @return void
     */
    public static function setup($channelName = Stream::DEFAULT_CHANNEL, $format = Format::LINE_FORMAT, $withJson = false)
    {
        self::$logDTO = new LogDTO();
        self::$logDTO->setChannel($channelName);
        self::$logDTO->setFormat($format);
        self::$logDTO->setWithJson($withJson);
    }
